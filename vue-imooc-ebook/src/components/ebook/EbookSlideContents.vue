    ...
    <div class="ebook-slide-contents">
        ...
        <div class="slide-contents-book-wrapper" v-show="!searchVisible">
            ...
            <div class="slide-contents-book-info-wrapper">
                <div class="slide-contents-book-title" v-if="menuVisible" >
                    <span class="slide-contents-book-title-text">{{metadata.title}}</span>
                    </div>
                <div class="slide-contents-book-auther" v-if="menuVisible">
                    <span class="slide-contents-book-auther-text">{{metadata.creator}}</span>
                </div>
            </div>
            <div class="slide-contents-book-progress-wrapper">
                ...
                <div class="slide-contents-book-time">{{getReasTimeText()}}</div>
            </div>
        </div>
    ...
    .ebook-slide-contents {
        ...
        .slide-contents-book-wrapper{
            ...
            .slide-contents-book-info-wrapper{
                ...
                .slide-contents-book-auther{
                    // width:px2rem(153.75);
                    font-size:px2rem(12);
                    margin-top:px2rem(5);
                    line-height:px2rem(14);
                    @include left;
                    .slide-contents-book-auther-text {
                        @include ellipsis2(1);
                    }
                }
            }
