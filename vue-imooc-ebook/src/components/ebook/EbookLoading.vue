<template>
    <div class="ebook-loading">
        <div class="ebook-loading-wrapper">
            <div class="ebook-loading-item" v-for="(item, index) in data"
            :key="index">
                <div class="ebook-loading-line-wrapper" v-for="(subItem,subIndex) in
                item" :key="subIndex">
        ...
        this.$refs.mask.forEach((item, index) => {
            ...
            if (index === 0) {
                ...
                if (this.add && maskWidth.value < 16) {
                   ...
                   let preMaskWidth = this.lineWidth[index - 1]
                    if (preMaskWidth.value >= 8) {
                      maskWidth.value--
                      lineWidth.value++
                    }
